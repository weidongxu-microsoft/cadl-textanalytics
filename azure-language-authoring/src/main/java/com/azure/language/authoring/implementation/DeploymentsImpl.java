...
public final class DeploymentsImpl {
     ...
     */
    DeploymentsImpl(MicrosoftCognitiveLanguageServiceAnalyzeTextAuthoringClientImpl client) {
        this.service =
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> deployProjectWithResponseAsync(
            String projectName, String deploymentName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
    ...
    public Response<BinaryData> deployProjectWithResponse(
            String projectName, String deploymentName, RequestOptions requestOptions) {
        return deployProjectWithResponseAsync(projectName, deploymentName, requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BinaryData>> deleteDeploymentWithResponseAsync(
            String projectName, String deploymentName, RequestOptions requestOptions) {
        final String accept = "application/json";
        return FluxUtil.withContext(
                context ->
    ...
    public Response<BinaryData> deleteDeploymentWithResponse(
            String projectName, String deploymentName, RequestOptions requestOptions) {
        return deleteDeploymentWithResponseAsync(projectName, deploymentName, requestOptions).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> swapDeploymentsWithResponseAsync(
    ...
    public Response<Void> swapDeploymentsWithResponse(
            String projectName, BinaryData body, RequestOptions requestOptions) {
        return swapDeploymentsWithResponseAsync(projectName, body, requestOptions).block();
    }
