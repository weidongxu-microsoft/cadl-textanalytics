...
import com.azure.language.authoring.models.TrainingJobOptions;
...
public final class ProjectsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Project> delete(String projectName) {
        RequestOptions requestOptions = new RequestOptions();
        return deleteWithResponse(projectName, requestOptions)
                .map(Response::getValue)
                .map(protocolMethodData -> protocolMethodData.toObject(Project.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> export(String projectName, String projectFileVersion) {
        RequestOptions requestOptions = new RequestOptions();
        return exportWithResponse(projectName, projectFileVersion, requestOptions).map(Response::getValue);
    }

    /*
     * Generated convenience method for importxWithResponse
     */
    /**
     * Triggers a job to export a project's data.
     *
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> importx(String projectName) {
        RequestOptions requestOptions = new RequestOptions();
        return importxWithResponse(projectName, requestOptions).map(Response::getValue);
    }

    /*
     * Generated convenience method for trainWithResponse
     */
    /**
     * Triggers a training job for a project.
     *
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> train(String projectName, TrainingJobOptions body) {
        RequestOptions requestOptions = new RequestOptions();
        return trainWithResponse(projectName, BinaryData.fromObject(body), requestOptions).map(Response::getValue);
    }
}
