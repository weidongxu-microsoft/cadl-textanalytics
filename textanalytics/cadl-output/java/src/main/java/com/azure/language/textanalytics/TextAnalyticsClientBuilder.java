...
package com.azure.language.textanalytics;
...
import com.azure.language.textanalytics.implementation.TextAnalyticsClientImpl;
...
@ServiceClientBuilder(serviceClients = {TextAnalyticsClient.class, TextAnalyticsAsyncClient.class})
public final class TextAnalyticsClientBuilder
        implements HttpTrait<TextAnalyticsClientBuilder>,
    ...
    @Generated
    private final Map<String, String> properties = CoreUtils.getProperties("azure-language-textanalytics.properties");
     ...
     * Service version
     */
    @Generated private TextAnalyticsServiceVersion serviceVersion;
     ...
     */
    @Generated
    public TextAnalyticsClientBuilder serviceVersion(TextAnalyticsServiceVersion serviceVersion) {
     ...
     */
    @Generated
    private TextAnalyticsClientImpl buildInnerClient() {
        HttpPipeline localPipeline = (pipeline != null) ? pipeline : createHttpPipeline();
        TextAnalyticsServiceVersion localServiceVersion =
                (serviceVersion != null) ? serviceVersion : TextAnalyticsServiceVersion.getLatest();
        TextAnalyticsClientImpl client =
                new TextAnalyticsClientImpl(
    ...
    /**
     * Builds an instance of TextAnalyticsAsyncClient class.
     *
     * @return an instance of TextAnalyticsAsyncClient.
     */
    @Generated
    public TextAnalyticsAsyncClient buildAsyncClient() {
        return new TextAnalyticsAsyncClient(buildInnerClient().getAnalyzes());
    }

    /**
     * Builds an instance of TextAnalyticsClient class.
     *
     * @return an instance of TextAnalyticsClient.
     */
    @Generated
    public TextAnalyticsClient buildClient() {
        return new TextAnalyticsClient(new TextAnalyticsAsyncClient(buildInnerClient().getAnalyzes()));
    }
}
