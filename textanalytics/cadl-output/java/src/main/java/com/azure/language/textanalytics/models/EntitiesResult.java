...
public final class EntitiesResult {
    ...
    private List<EntitiesDocumentResult> documents;
    ...
    public EntitiesResult(
            @JsonProperty(value = "documents", required = true) List<EntitiesDocumentResult> documents,
     ...
     */
    public List<EntitiesDocumentResult> getDocuments() {
     ...
     */
    public EntitiesResult setStatistics(DocumentRequestStatistics statistics) {
