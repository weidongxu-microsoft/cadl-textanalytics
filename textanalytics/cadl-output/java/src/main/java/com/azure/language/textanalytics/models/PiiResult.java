...
public final class PiiResult {
    ...
    private List<PiiEntitiesDocumentResult> documents;
    ...
    @JsonCreator
    public PiiResult(
            @JsonProperty(value = "documents", required = true) List<PiiEntitiesDocumentResult> documents,
     ...
     */
    public List<PiiEntitiesDocumentResult> getDocuments() {
     ...
     */
    public PiiResult setStatistics(DocumentRequestStatistics statistics) {
