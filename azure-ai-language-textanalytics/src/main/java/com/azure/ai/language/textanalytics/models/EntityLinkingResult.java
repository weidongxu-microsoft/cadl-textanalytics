...
public final class EntityLinkingResult {
    ...
    private List<LinkedEntitiesDocumentResult> documents;
    ...
    public EntityLinkingResult(
            @JsonProperty(value = "documents", required = true) List<LinkedEntitiesDocumentResult> documents,
     ...
     */
    public List<LinkedEntitiesDocumentResult> getDocuments() {
     ...
     */
    public EntityLinkingResult setStatistics(DocumentRequestStatistics statistics) {
