...
public final class ErrorCode extends ExpandableStringEnum<ErrorCode> {
    ...
    /** Static value AzureCognitiveServiceNotFound for ErrorCode. */
    public static final ErrorCode AZURE_COGNITIVE_SERVICE_NOT_FOUND = fromString("AzureCognitiveServiceNotFound");
