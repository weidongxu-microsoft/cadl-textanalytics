...
import com.azure.ai.language.authoring.implementation.JobsImpl;
...
public final class JobsAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DeploymentJob> getDeploymentStatus(String projectName, String deploymentName, String jobId) {
        ...
        return getDeploymentStatusWithResponse(projectName, deploymentName, jobId, requestOptions)
                ...
                .map(protocolMethodData -> protocolMethodData.toObject(DeploymentJob.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<SwapDeploymentsJob> getSwapDeploymentsStatus(String projectName, String deploymentName, String jobId) {
        ...
        return getSwapDeploymentsStatusWithResponse(projectName, deploymentName, jobId, requestOptions)
                .map(Response::getValue)
                .map(protocolMethodData -> protocolMethodData.toObject(SwapDeploymentsJob.class));
    }
}
